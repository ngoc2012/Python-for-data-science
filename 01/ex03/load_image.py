...
def dislay_img(image_array: np.ndarray) -> None:
    ...
    draw.rectangle([(margin_left - line_width / 2 + 1, margin_top - line_width / 2 + 1), (margin_left + width + line_width / 2 + 1, height + margin_top + line_width / 2 + 1)], outline="black", width=line_width)
